...
export const ModalAINewsOrganism = () => {
    ...
    return <div className={'modal-ai-news-organism'}>
        <SearchBox title={'検索'} name={'search'} placeHolder={'記事タイトル / 区分 / タグ'} inputRef={searchRef}
        ...
        <div className={'ai-news-content'}>
            ...
            >
                <div style={{ width: '616px' }} className={' '}>
                    <InputWithTitle name={'title'} placeHolder={''} inputRef={titleRef} title={'タイトル'}
                        type={InputType.TEXT} />
                </div>
                ...
                <div style={{ width: '616px' }} className={'mt-6'}>
                    <InputWithTitle name={'link'} placeHolder={''} inputRef={linkRef} type={InputType.TEXT}
                        title={'リンク'} />
                </div>
                <div style={{ width: '368px' }} className={'mt-6'}>
                    <InputWithTitle options={distinguishs} name={'tag'} inputRef={distinguishRef}
