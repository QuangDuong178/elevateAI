...
export const SearchBox: ForwardRefRenderFunction<HTMLInputElement, SearchBoxProps> = (props, ref) => {

    return (
        <div className={"search-box-molecules"}>
            <Title text={props.title} />
            <div className={"flex place-items-center mt-2"}>
                <CommonSearch name={props.name} placeHolder={props.placeHolder} inputRef={ref} />
